...
#         print("median pos index:", med_pos)
    ...
    if quadsection:
        quad_intersection_pt = intersection_pt
        ...
        if get_slope(A,B) <= get_slope(quad_intersection_pt, end_quad_intersection_pt) <= get_slope(intersection_pt, end_intersection_pt):
